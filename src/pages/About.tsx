...
const values = [
  {
    ...
    title: "Safety First",
    description:
      "We prioritize the safety of every commuter, especially women, with robust safety features and emergency support.",
  },
  {
    icon: Target,
    title: "Locally Focused",
    description:
      "Built specifically for Kolkata and Greater Kolkata, understanding the unique needs of our city's commuters.",
  },
  {
    icon: Users,
    title: "Community Driven",
    description:
      "Powered by community feedback and local insights to continuously improve transport information.",
  },
  {
    icon: Heart,
    title: "Accessible to All",
    description:
      "Free, easy-to-use platform accessible to all commuters regardless of technical expertise.",
  },
];
        ...
        <div className="container">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              About <span className="text-gradient-primary">SafeRoute</span>
            </h1>
