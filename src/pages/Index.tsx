...
import { MapPin, Shield, Bus, Phone, Navigation, Users, CheckCircle, ArrowRight, Star, Command } from "lucide-react";
const features = [{
  icon: Bus,
  title: "Local Transport Finder",
  description: "Find nearest auto, bus, and shared transport routes across Kolkata with pickup locations and stoppages."
}, {
  icon: Shield,
  title: "Women Safety Module",
  description: "Get safest route suggestions with well-lit paths, emergency SOS, and one-tap helpline access."
}, {
  icon: Navigation,
  title: "Route Planning",
  description: "Plan your journey with detailed route paths, stoppages, and area-based transport search."
}, {
  icon: MapPin,
  title: "Suburban Connectivity",
  description: "Coverage for Greater Kolkata including New Town, Salt Lake, Howrah, Barasat, and more."
}];
const coverageAreas = ["Central Kolkata", "Salt Lake", "New Town", "Howrah", "Barasat", "Madhyamgram", "Rajarhat", "Garia", "Sonarpur"];
const Index = () => {
  return <Layout>
      {/* Hero Section */}
            ...
            duration: 0.6
              ...
              <div className="flex items-center gap-6 pt-4">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map(i => <div key={i} className="w-10 h-10 rounded-full bg-gradient-primary border-2 border-background flex items-center justify-center">
              ...
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute inset-0 rounded-3xl bg-gradient-card shadow-medium border border-border overflow-hidden">
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400">
                    <path d="M100 100 Q200 150 200 200 T300 300" fill="none" stroke="hsl(185 65% 28%)" strokeWidth="3" strokeDasharray="10 5" opacity="0.5" />
                    <path d="M300 100 Q250 200 200 200 T100 300" fill="none" stroke="hsl(158 64% 42%)" strokeWidth="3" strokeDasharray="10 5" opacity="0.5" />
                  </svg>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            once: true
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {coverageAreas.map(area => <span key={area} className="px-4 py-2 rounded-full bg-background border border-border text-sm font-medium">
                    {area}
                  </span>)}
              </div>
      ...
      <section className="py-20 md:py-28 bg-gradient-primary relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          once: true
            ...
            <Command className="w-16 h-16 text-primary-foreground/80 mx-auto mb-6" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="accent" size="xl" asChild className="text-foreground">
                <Link to="/safety">
