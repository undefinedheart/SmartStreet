...
const safetyFeatures = [
  {
    ...
    description:
      "Get routes that prioritize well-lit, populated main roads for safer travel, especially during late hours.",
  },
  {
    icon: Share2,
    title: "Live Location Sharing",
    description:
      "Share your real-time location with trusted contacts while traveling for added peace of mind.",
  },
  {
    icon: Moon,
    title: "Night Travel Tips",
    description:
      "Access safety guidelines specific to late-evening and suburban travel in Kolkata.",
  },
  {
    icon: Users,
    title: "Community Safety",
    description:
      "Report and view safety alerts from other commuters in your area for collective awareness.",
  },
];

const safetyTips = [
  "Always share your live location with a trusted contact when traveling late",
  "Prefer well-lit main roads over shortcuts through isolated areas",
  "Keep emergency numbers saved on speed dial",
  "Trust your instincts - if something feels wrong, move to a crowded area",
  "Note down vehicle registration numbers when using autos or cabs",
  "Avoid displaying expensive jewelry or electronics in public transport",
];
